...
# Tujuan
Transformasi model logis ke model fisik dan implementasi nyata di PostgreSQL, termasuk:
- Pembuatan tabel dengan constraint (PK, FK, CHECK, UNIQUE, DEFAULT).
- Pengisian data awal (dummy data).
- Query untuk mission objectives (menu, pesanan, pemasukan, stok, bahan baku, staff).
